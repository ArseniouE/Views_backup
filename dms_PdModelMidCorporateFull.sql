...
/****** Object:  View [dbo].[dms_PdModelMidCorporateFull]    Script Date: 25/10/2023 2:05:31 μμ ******/
SET ANSI_NULLS ON
GO
...
create  view [dbo].[dms_PdModelMidCorporateFull] as
...
and a.modelid = 'PdModelMidCorporateFull'
GO
