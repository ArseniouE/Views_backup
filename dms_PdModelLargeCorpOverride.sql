...
/****** Object:  View [dbo].[dms_PdModelLargeCorpOverride]    Script Date: 25/10/2023 2:04:37 μμ ******/
SET ANSI_NULLS ON
GO
...
create  view [dbo].[dms_PdModelLargeCorpOverride] as
...
and a.modelid = 'PdModelLargeCorpOverride'
GO
