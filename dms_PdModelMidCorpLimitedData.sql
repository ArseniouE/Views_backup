...
/****** Object:  View [dbo].[dms_PdModelMidCorpLimitedData]    Script Date: 25/10/2023 2:05:06 μμ ******/
SET ANSI_NULLS ON
GO
...
create  view [dbo].[dms_PdModelMidCorpLimitedData] as
...
and a.modelid = 'PdModelMidCorpLimitedData'
