...
/****** Object:  View [dbo].[dms_PdModelNonSystemicLondon]    Script Date: 25/10/2023 2:05:51 μμ ******/
SET ANSI_NULLS ON
GO
...
create  view [dbo].[dms_PdModelNonSystemicLondon] as
...
and a.LuxModelid = 'PdModelNonSystemic'
