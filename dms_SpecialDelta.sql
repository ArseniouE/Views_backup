...
/****** Object:  View [dbo].[dms_SpecialDelta]    Script Date: 25/10/2023 2:08:48 μμ ******/
SET ANSI_NULLS ON
GO
...
select distinct 
	...
	case when a.reason = 'Empirical rating from Alpha Bank Luxemburg Branch' then 'NAI' else 'ΟΧΙ'
	end									as IsLux,
	null								as Deactivation,
	a.[EntityId]						as EntityId, 
	'Ειδικη Διαβάθμιση Εκτός συτήματος'	as RatingReason, --ref data SpecialDeltaRatingReason αυτό πρέπει να αλλαχτεί 
