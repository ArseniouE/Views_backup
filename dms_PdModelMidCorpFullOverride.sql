...
/****** Object:  View [dbo].[dms_PdModelMidCorpFullOverride]    Script Date: 25/10/2023 2:04:55 μμ ******/
SET ANSI_NULLS ON
GO
...
create  view [dbo].[dms_PdModelMidCorpFullOverride] as
...
and a.modelid = 'PdModelMidCorpFullOverride'
GO
