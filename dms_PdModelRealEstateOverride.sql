...
/****** Object:  View [dbo].[dms_PdModelRealEstateOverride]    Script Date: 25/10/2023 2:06:35 μμ ******/
SET ANSI_NULLS ON
GO
...
create  view [dbo].[dms_PdModelRealEstateOverride] as
...
and a.modelid = 'PdModelRealEstateOverride'
GO
