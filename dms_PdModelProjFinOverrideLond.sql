...
/****** Object:  View [dbo].[dms_PdModelProjFinOverrideLond]    Script Date: 25/10/2023 2:06:14 μμ ******/
SET ANSI_NULLS ON
GO
...
create  view [dbo].[dms_PdModelProjFinOverrideLond] as
...
and a.LuxModelid = 'PdModeProjFinSlotAprOver'
GO
