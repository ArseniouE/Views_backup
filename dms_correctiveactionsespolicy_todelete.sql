...
/****** Object:  View [dbo].[dms_correctiveactionsespolicy_todelete]    Script Date: 25/10/2023 2:01:13 μμ ******/
SET ANSI_NULLS ON
GO
...
--drop view [dms_correctiveactionsespolicy]
create view [dbo].[dms_correctiveactionsespolicy_todelete] as 
