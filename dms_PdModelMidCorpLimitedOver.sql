...
/****** Object:  View [dbo].[dms_PdModelMidCorpLimitedOver]    Script Date: 25/10/2023 2:05:20 μμ ******/
SET ANSI_NULLS ON
GO
...
create  view [dbo].[dms_PdModelMidCorpLimitedOver] as
...
and a.modelid = 'PdModelMidCorpLimitedOver'
GO
