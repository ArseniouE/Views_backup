...
/****** Object:  View [dbo].[dms_PdModeProjFinSlotAprOver]    Script Date: 25/10/2023 2:07:38 μμ ******/
SET ANSI_NULLS ON
GO
...
create  view [dbo].[dms_PdModeProjFinSlotAprOver] as
...
and a.modelid = 'PdModeProjFinSlotAprOver'
